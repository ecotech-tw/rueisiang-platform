...
export interface OvertimeRequest { request: { id: string; requestedStart: string; requestedEnd: string; settlementKind: "pay" | "compensatory"; ratePpm: number; reason: string; status: "draft" | "pending" | "approved" | "rejected" | "cancelled"; decisionReason: string; createdAt: string }; employeeName: string | null }
