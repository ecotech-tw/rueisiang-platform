...
export const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    icon: "widgets",
    items: [
      { label: "報表檢視", to: "/tools/reports", permission: "reports:cyberbiz:read", icon: "analytics" },
      ...
      { label: "蝦皮銷售報表", to: "/tools/shopee-sales", permission: "tools:shopee-sales:run", icon: "bag" },
