...
const employee: Profile["employee"] = { id: "e", employeeNumber: "E001", displayName: "測試員工", userId: null, revision: 1 };
...
describe("人事資料呈現", () => {
  it("未任職與未指派都呈現明確空狀態", () => {
    ...
    expect(html).toContain("離職不會自動停用登入帳號");
  });
  ...
  it("呈現復職歷史與半開期間，姓名不解析為 HTML", () => {
    const profile: Profile = {
      ...
      employments: [
        { id: "j1", employerName: "雇主甲", hiredOn: "2026-01-01", endedOn: "2026-02-01", seniorityStartOn: "2026-01-01", revision: 2 },
        { id: "j2", employerName: "雇主乙", hiredOn: "2026-03-01", endedOn: null, seniorityStartOn: "2026-01-01", revision: 1 },
      ],
    ...
    expect(html).toContain("<td>雇主乙</td><td>測試櫃</td>");
