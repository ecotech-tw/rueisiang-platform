 ...
 * 目前是 CYBERBIZ_API_TOKEN、GOOGLE_MAPS_API_KEY、Gemini／Codex credential 與可選的 LINE_CHANNEL_ACCESS_TOKEN。
 * 沒有這個檔也能跑，只是碰到 CYBERBIZ、Google Maps、AI Sandbox 或 LINE 回覆的功能會失敗。
 */
