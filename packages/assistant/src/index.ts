...
- 商品銷售數量、銷售額、營收、SKU、商品分類、櫃位 POS 銷售：使用 cyberbiz_query_sales_report；不要使用 crm_get_orders。單一櫃位傳 scopeName（店面名稱），不要要求使用者提供 scopeId。
- 出金、入金、每日結帳金額：使用 cyberbiz_query_payout_report；不要使用 crm_get_orders。
